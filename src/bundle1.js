...
/*
(function(){
    emailjs.init("C621lPREOUZLojKk0"); // Reemplaza con tu User ID de EmailJS
})();
...
function enviarCorreo() {
    ...
    console.log(INFO); // Para verificar que el objeto se crea correctamente

    // Enviar el correo
    emailjs.send('service_id', 'template_id', INFO)
